...
const app = express();
const arrData = [];
const fileDatabase = 'public/12-01-database.db';
const fileName = 'public/12-01-data.json';
const port = 3000;
...
app.use(express.static('public', { index: '12-01-geolocation-link.html' }));      // default '12-01-geolocation-link.html'
...
/* -------------------- */
/* Running Command */
// node 12-01-database.js
// node ./58-codingtrain-javascript-api/12-01-database.js

// Setup, create symbolic link 12-01-geolocation.html to public directory
// cd public
// ln -s ../12-01-geolocation.html 12-01-geolocation-link.html
