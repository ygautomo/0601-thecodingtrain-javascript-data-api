...
// app.use(express.static('public', { index: '08-01-satellite-mapbox-interval-link.html' }));      // default '08-01-satellite-iss-link.html'
app.use(express.static('public', { index: '09-04-welcome-link.html' }));                        // default '09-04-welcome-link.html'
...
/* -------------------- */
/* Running Command */
// node 09-04-express.js
// node ./58-codingtrain-javascript-api/09-04-express.js
...
// Setup, create symbolic link 08-01-satellite-mapbox-interval.html to public directory
// cd public
// ln -s ../08-01-satellite-mapbox-interval.html 08-01-satellite-mapbox-interval-link.html
// ln -s ../07-isssatellite.png 07-isssatellite.png
// ln -s ../09-04-welcome.html 09-04-welcome-link.html
// ln -s ../09-04-goodbye.html 09-04-goodbye-link.html
...
// [GET/POST/PUT/PATCH/DELETE] `http://{{IP_ADDRESS}}:3000/08-01-satellite-iss-link.html`

// Test HTTP server status with method- return API status
// Web `http://{{IP_ADDRESS}}:3000`
// Postman [GET/POST/PUT/PATCH/DELETE] `http://{{IP_ADDRESS}}:3000`                                // Postman 12 Codingtrain Javascript API -- 09-04-express
