 ...
 * Filename: 11-03-post-request.js
...
const app = express();
const arrData = [];
const fileName = 'public/11-03-data.json';
const port = 3000;
...
app.use(express.static('public', { index: '11-03-geolocation-link.html' }));      // default '11-03-geolocation-link.html'
...
/* -------------------- */
/* Running Command */
// node 11-03-post-request.js
// node ./58-codingtrain-javascript-api/11-03-post-request.js

// Setup, create symbolic link 11-03-geolocation.html to public directory
// cd public
// ln -s ../11-03-geolocation.html 11-03-geolocation-link.html
