...
console.log("Yugo Gautomo");    // return "Yugo Gautomo"
...
var yourName;
let yourAge;
const numberOfDays = 7;         // declaration statement
let x = 5;
console.log(x+2);               // return 7

const message = (name) => {
	console.log(`Hello ${name}`);
};

message('JavaScript');          // return "JavaScript"

/* -------------------- */
/* Running Command */
// node 09-01-helloworld.js
// node ./58-codingtrain-javascript-api/09-01-helloworld.js
